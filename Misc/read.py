...
path_base='F:\OF-FWH'
file_name='p_cylinder.raw' # name of the surface sampling data for every time step
patch= 'cylinder' # name of the patch where surface pressure was sampled


#------------------------------------------------------
path=path_base+'/postProcessing/surfaceSampling/'
...
xyz_mesh = points[20:-4] #delete first 21 rows for header and the last 4
...
pickle.dump([A, n, c_xyz, p_cxyz], f, protocol=2)
f.close()
