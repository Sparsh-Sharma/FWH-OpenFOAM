...
for x0 in x0_values:
    ...
    for i, freq in enumerate(freq_of_interest):
        ...
        # # Plot airfoil at the center
        # airfoil_x, airfoil_y = generate_naca0012_coordinates()
        # ax.plot(2 * np.pi * airfoil_x, airfoil_y, color='gray', linestyle='--', label='NACA0012 Airfoil')
        ...
        plt.savefig(f'Directivity_Polar_plot_x0_{x0}_freq_{freq}Hz.pdf', bbox_inches='tight', dpi=300)
